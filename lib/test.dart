...
// Draw second step progress
    ...
    if (progress >= 0.66) {
      canvas.drawArc(
          ...
          progress2 * 1.9 * math.pi - math.pi / 180 * 5,
          false,
          paint2);
    }
...
// Draw third step progress
    ...
    canvas.drawArc(
        Rect.fromCircle(center: center, radius: radius),
        -math.pi / 2 + 0.66 * 2 * math.pi + math.pi / 180 * 5,
        0.66 * 0.98 * math.pi - math.pi / 180 * 10,
        false,
        background3);
    ...
    if (progress == 1.0) {
      canvas.drawArc(
          Rect.fromCircle(center: center, radius: radius),
          -math.pi / 2 + 0.66 * 2 * math.pi + math.pi / 180 * 5,
          progress3 * 1.9 * math.pi - math.pi / 180 * 10,
          false,
          paint3);
    }
  }
